...
(defn iterate-plan [t]
  (let [t2 (assoc t :ccs (map (partial consume (t :private-goods) (t :private-good-prices) (t :public-goods-types) (t :public-goods-prices) (count (t :ccs)))
                              (t :ccs))
