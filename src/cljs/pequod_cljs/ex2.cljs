...
(def wcs2
 [{:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.04269867884408479],
  :industry 1,
  :pollutant-exponents [0.2781965664900581],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[1 3 4] [1] [1] [1]],
  :input-exponents
  [0.09877256483872165 0.031991908246565615 0.0090198853200527],
  :xe 0.05,
  :nature-exponents [0.16339083204892424],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.14963002603602255],
  :industry 1,
  :pollutant-exponents [0.16950959236075558],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[1 2 3 4] [1] [1] [1]],
  :input-exponents
  [0.000512561110327217
   0.04069197399896809
   0.026993296354692147
   0.00568795533963064],
  :xe 0.05,
  :nature-exponents [0.2209252167199632],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.0929294596952207],
  :industry 1,
  :pollutant-exponents [0.034343140134434055],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[2 3 4] [1] [1] [1]],
  :input-exponents
  [0.001122779808920904 0.03888930502521121 0.018405002578931972],
  :xe 0.05,
  :nature-exponents [0.22499958314058424],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.005607858250617969],
  :industry 1,
  :pollutant-exponents [0.17760004826709666],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :input-exponents
  [0.01424955396741661
   0.043003926418104514
   0.05616798970134083
   0.022099109626804392],
  :xe 0.05,
  :nature-exponents [0.22337535659207045],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.17482810590197656],
  :industry 1,
  :pollutant-exponents [0.034838601926092845],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  :product 2,
  :labor-quantities [0],
  :production-inputs [[1 2 4] [1] [1] [1]],
  :input-exponents
  [0.065995362930103 0.057135637800057634 0.062476486916293365],
  :xe 0.05,
  :nature-exponents [0.27666572765993447],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.10847352874229474],
  :industry 1,
  :pollutant-exponents [0.23602927557834713],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  [0.0664111721292807
   0.04204750932011178
   0.044483789828605146
   0.02499461387127156],
  :xe 0.05,
  :nature-exponents [0.052423010550783286],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.2695562128215162],
  :industry 1,
  :pollutant-exponents [0.15114112580447],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  :product 3,
  :labor-quantities [0],
  :production-inputs [[4] [1] [1] [1]],
  :input-exponents [0.1070812738633414],
  :xe 0.05,
  :nature-exponents [0.14902209750296735],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.11533498889691696],
  :industry 1,
  :pollutant-exponents [0.16544855864484367],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[4] [1] [1] [1]],
  :input-exponents [0.05339887854081819],
  :xe 0.05,
  :nature-exponents [0.023204395958230404],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.25665603961596584],
  :industry 1,
  :pollutant-exponents [0.01500087242432756],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[3] [1] [1] [1]],
  :input-exponents [0.24927898604439575],
  :xe 0.05,
  :nature-exponents [0.00856063350742231],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.19414403518480092],
  :industry 1,
  :pollutant-exponents [0.2857913529553584],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[4] [1] [1] [1]],
  :input-exponents [0.091601617659021],
  :xe 0.05,
  :nature-exponents [0.020373165971844773],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.19781412559492428],
  :industry 1,
  :pollutant-exponents [0.2719099213383789],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :input-exponents
  [0.06412398490168597 0.06413200440265697 0.05364701168687231],
  :xe 0.05,
  :nature-exponents [0.2065732935469959],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.22242865502889753],
  :industry 1,
  :pollutant-exponents [0.07738703218835113],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  :product 4,
  :labor-quantities [0],
  :production-inputs [[2 3] [1] [1] [1]],
  :input-exponents [0.04846247850597328 0.01341790733959296],
  :xe 0.05,
  :nature-exponents [0.16015062497574817],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.14034704889966382],
  :industry 0,
  :pollutant-exponents [0.07567948651888406],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  :product 1,
  :labor-quantities [0],
  :production-inputs [[2] [1] [1] [1]],
  :input-exponents [0.2522742051498715],
  :xe 0.05,
  :nature-exponents [0.07099660495969048],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.18189554948000297],
  :industry 0,
  :pollutant-exponents [0.0909788655234087],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[2 3 4] [1] [1] [1]],
  :input-exponents
  [0.052918320880030206 0.004483741583633449 0.000950252366251325],
  :xe 0.05,
  :nature-exponents [0.28784239598968864],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.23160565824634244],
  :industry 0,
  :pollutant-exponents [0.29662512459590484],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :input-exponents
  [0.04146719821430367
   0.034502492980969475
   0.07363284809531985
   0.0024210811317233127],
  :xe 0.05,
  :nature-exponents [0.2112033065555997],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.1389056074541727],
  :industry 0,
  :pollutant-exponents [0.14600331432530184],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[2 3 4] [1] [1] [1]],
  :input-exponents
  [0.03888857371232975 0.08031184016347637 0.058524544942984806],
  :xe 0.05,
  :nature-exponents [0.28497507648607256],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.035907350222876486],
  :industry 0,
  :pollutant-exponents [0.17499147021874323],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[1 4] [1] [1] [1]],
  :input-exponents [0.0029595908088973053 0.0460595083526157],
  :xe 0.05,
  :nature-exponents [0.2886851342250861],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.20496110505023343],
  :industry 0,
  :pollutant-exponents [0.07106842107814461],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[4] [1] [1] [1]],
  :input-exponents [0.036159277729352686],
  :xe 0.05,
  :nature-exponents [0.2860313239018288],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.004061281905238345],
  :industry 0,
  :pollutant-exponents [0.18332705085850923],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[1 2 3] [1] [1] [1]],
  :input-exponents
  [0.034879557641210895 0.024948070703338696 0.0761519985010615],
  :xe 0.05,
  :nature-exponents [0.2716059389302545],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.26323450785285635],
  :industry 0,
  :pollutant-exponents [0.09728970492792463],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :labor-quantities [0],
  :production-inputs [[1 4] [1] [1] [1]],
  :input-exponents [0.03191312675107182 0.13593632209314319],
  :xe 0.05,
  :nature-exponents [0.17385472495889862],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.04880253061652329],
  :industry 0,
  :pollutant-exponents [0.28770345095069483],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[1 3 4] [1] [1] [1]],
  :input-exponents
  [0.0015435705557846234 0.007440429605969001 0.005857056570002238],
  :xe 0.05,
  :nature-exponents [0.18647759890275784],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.13889617988903985],
  :industry 0,
  :pollutant-exponents [0.05575636480178474],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[1 3 4] [1] [1] [1]],
  :input-exponents
  [0.07865263222314588 0.09959404575959634 0.02066071779045081],
  :xe 0.05,
  :nature-exponents [0.2139811837365831],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.1378983265496113],
  :industry 0,
  :pollutant-exponents [0.22902203522979203],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  :product 4,
  :labor-quantities [0],
  :production-inputs [[2 4] [1] [1] [1]],
  :input-exponents [0.10049687534109489 0.07604600936081747],
  :xe 0.05,
  :nature-exponents [0.006345885465551748],
  :a 0.25}
 {:effort 0.5,
  :cq 0.25,
  :ce 1,
  :labor-exponents [0.17703599739650644],
  :industry 0,
  :pollutant-exponents [0.2302698431269531],
  :output 0,
  :s 1,
  :du 7,
  :c 0.05,
  ...
  :production-inputs [[2 3 4] [1] [1] [1]],
  :input-exponents
  [0.004991348848381571 0.01845185885699043 0.08190393510764887],
  :xe 0.05,
  :nature-exponents [0.14549737730511594],
  :a 0.25}]
)
